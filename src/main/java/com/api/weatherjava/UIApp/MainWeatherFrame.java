...
public class MainWeatherFrame extends javax.swing.JFrame {
    ...
    public MainWeatherFrame(FeedEntry entry) {
     ...
     private void initComponents() {
        ...
        DayLabel.setFont(new Font("Segoe UI", 0, 12)); // NOI18N
        DayLabel.setForeground(new Color(255, 255, 255));
        DayLabel.setText("THURSDAY 9TH");
        jPanel2.add(DayLabel, new AbsoluteConstraints(40, 430, 90, -1));
    ...
    private void RefreshIconLabelMouseClicked(MouseEvent evt) {                                              
        timer.stop();
        final BackgroundWorker worker = new BackgroundWorker(entry, DynJLabelList, CurrentTempLabel, DayLabel, DescriptionLabel,
